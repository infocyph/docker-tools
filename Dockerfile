...
RUN apk add --no-cache \
      ...
      docker-cli docker-cli-compose yq ripgrep fd shellcheck zip unzip nano nano-syntax pandoc imagemagick imagemagick-webp libwebp-tools ffmpeg sox mkvtoolnix mediainfo xvidcore \
