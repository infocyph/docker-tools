    ...
    <div id="apDriftRefreshMeta" class="ap-live-refresh-meta" aria-live="polite">
      <div class="ap-live-meta-row">
        ...
        <div class="ap-live-meta-controls">
          <label class="ap-live-auto-switch" for="apDriftAuto">
            <span class="ap-live-auto-switch-label">Auto</span>
            <input id="apDriftAuto" type="checkbox" role="switch" aria-label="Auto refresh drift monitor">
          </label>
          <button id="apDriftRefreshBtn" class="btn ap-live-meta-refresh" type="button" aria-label="Refresh drift monitor" title="Refresh">
