    ...
    <div id="apHeatRefreshMeta" class="ap-live-refresh-meta" aria-live="polite">
      <div class="ap-live-meta-row">
        ...
        <div class="ap-live-meta-controls">
          <label class="ap-live-auto-switch" for="apHeatAuto">
            <span class="ap-live-auto-switch-label">Auto</span>
            <input id="apHeatAuto" type="checkbox" role="switch" aria-label="Auto refresh log heatmap">
          </label>
          <button id="apHeatRefreshBtn" class="btn ap-live-meta-refresh" type="button" aria-label="Refresh log heatmap" title="Refresh">
