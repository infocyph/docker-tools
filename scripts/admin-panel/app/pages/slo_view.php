    ...
    <div id="apSloRefreshMeta" class="ap-live-refresh-meta" aria-live="polite">
      <div class="ap-live-meta-row">
        ...
        <div class="ap-live-meta-controls">
          <label class="ap-live-auto-switch" for="apSloAuto">
            <span class="ap-live-auto-switch-label">Auto</span>
            <input id="apSloAuto" type="checkbox" role="switch" aria-label="Auto refresh SLO view">
          </label>
          <button id="apSloRefreshBtn" class="btn ap-live-meta-refresh" type="button" aria-label="Refresh SLO view" title="Refresh">
