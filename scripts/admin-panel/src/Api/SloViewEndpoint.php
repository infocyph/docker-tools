...
use AdminPanel\Service\SloViewService;

final class SloViewEndpoint
{
    private SloViewService $service;

    public function __construct(?SloViewService $service = null)
    {
        $this->service = $service ?? new SloViewService();
    }
