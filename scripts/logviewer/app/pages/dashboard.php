  ...
  <div class="row g-3">
    <div class="col-12 col-lg-4">
      <div class="card lv-card">
        <div
          class="card-header lv-card-header d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              foreach ($domains as $d): ?>
                <a class="btn btn-sm lv-btn"
                   href="/?p=logs&domain=<?= urlencode($d) ?>">
    ...
    <div class="col-12 col-lg-8">
      <div class="card lv-card">
        <div
          ...
          <span
            class="badge text-bg-secondary"><?= (int)($logCounts['total'] ?? 0) ?> files</span>
        </div>

        <div class="card-body">
          <?php
          if ((int)($logCounts['total'] ?? 0) === 0): ?>
            <div class="lv-muted">No log files found.</div>
          <?php
          else: ?>
            <div class="d-flex flex-wrap gap-2">
              <?php
              foreach (($logCounts['by_dir'] ?? []) as $dir => $cnt): ?>
