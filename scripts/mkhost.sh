...
###############################################################################
cleanup_vars() {
  unset -v DOMAINS DOMAIN_NAME APP_TYPE SERVER_TYPE     ENABLE_HTTPS ENABLE_REDIRECTION KEEP_HTTP     DOC_ROOT CLIENT_MAX_BODY_SIZE CLIENT_MAX_BODY_SIZE_APACHE     ENABLE_STREAMING PROXY_STREAMING_INCLUDE FASTCGI_STREAMING_INCLUDE APACHE_STREAMING_INCLUDE     ENABLE_CLIENT_VERIFICATION CLIENT_VERIF     PHP_VERSION PHP_CONTAINER_PROFILE PHP_CONTAINER PHP_APACHE_CONTAINER_PROFILE PHP_APACHE_CONTAINER     NODE_VERSION NODE_CMD NODE_PROFILE NODE_SERVICE NODE_CONTAINER NODE_COMPOSE_FILE_BASENAME     NODE_DIR_TOKEN GENERATED_NGINX_CONF_BASENAME GENERATED_APACHE_CONF_BASENAME || true
}
